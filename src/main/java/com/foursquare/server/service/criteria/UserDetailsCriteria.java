...
/**
 * Criteria class for the {@link com.foursquare.server.domain.UserDetails} entity. This class is used
 * in {@link com.foursquare.server.web.rest.UserDetailsResource} to receive all the possible filtering options from
...
public class UserDetailsCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, phone, createdBy, createdDate, lastModifiedBy, lastModifiedDate, userId, distinct);
    }
