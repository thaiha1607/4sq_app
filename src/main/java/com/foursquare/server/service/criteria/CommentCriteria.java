...
/**
 * Criteria class for the {@link com.foursquare.server.domain.Comment} entity. This class is used
 * in {@link com.foursquare.server.web.rest.CommentResource} to receive all the possible filtering options from
...
public class CommentCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, rating, content, createdBy, createdDate, lastModifiedBy, lastModifiedDate, userId, productId, distinct);
    }
