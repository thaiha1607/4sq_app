...
/**
 * Criteria class for the {@link com.foursquare.server.domain.Tag} entity. This class is used
 * in {@link com.foursquare.server.web.rest.TagResource} to receive all the possible filtering options from
...
public class TagCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, createdBy, createdDate, lastModifiedBy, lastModifiedDate, productId, distinct);
    }
