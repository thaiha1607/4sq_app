...
/**
 * Criteria class for the {@link com.foursquare.server.domain.InternalOrderHistory} entity. This class is used
 * in {@link com.foursquare.server.web.rest.InternalOrderHistoryResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /internal-order-histories?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InternalOrderHistoryCriteria implements Serializable, Criteria {
    ...
    public InternalOrderHistoryCriteria() {}

    public InternalOrderHistoryCriteria(InternalOrderHistoryCriteria other) {
    ...
    @Override
    public InternalOrderHistoryCriteria copy() {
        return new InternalOrderHistoryCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InternalOrderHistoryCriteria that = (InternalOrderHistoryCriteria) o;
        return (
    ...
    public String toString() {
        return "InternalOrderHistoryCriteria{" +
