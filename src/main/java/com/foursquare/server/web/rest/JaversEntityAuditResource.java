...
import com.foursquare.server.web.rest.dto.EntityAuditEvent;
...
public class JaversEntityAuditResource {
    ...
    public ResponseEntity<List<EntityAuditEvent>> getChanges(
        ...
        var entityTypeToFetch = Class.forName("com.foursquare.server." + entityType);
    ...
    public ResponseEntity<EntityAuditEvent> getPrevVersion(
        ...
        var entityTypeToFetch = Class.forName("com.foursquare.server." + qualifiedName);
