...
import com.foursquare.server.broker.KafkaConsumer;
...
@RestController
@RequestMapping("/api/foursquare-app-kafka")
public class FoursquareAppKafkaResource {
    ...
    public FoursquareAppKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
