  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        <h2 id="foursquareApp.product.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">Create or edit a Product</h2>
        <div>
          ...
          <div class="form-group">
            ...
            <input
              ...
              id="product-provider"
              data-cy="provider"
              :class="{ valid: !v$.provider.$invalid, invalid: v$.provider.$invalid }"
              v-model="v$.provider.$model"
            />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="form-control-label" for="product-createdDate">Created Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" for="product-lastModifiedBy">Last Modified By</label>
            <input
              type="text"
              class="form-control"
              name="lastModifiedBy"
          ...
          <div class="form-group">
            <label class="form-control-label" for="product-lastModifiedDate">Last Modified Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            ...
            >
              <option v-bind:value="getSelected(product.tags, tagOption, 'id')" v-for="tagOption in tags" :key="tagOption.id">
                {{ tagOption.name }}
              </option>
            </select>
          </div>
