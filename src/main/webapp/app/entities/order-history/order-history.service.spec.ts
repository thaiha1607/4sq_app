...
import { OrderHistory } from '@/shared/model/order-history.model';
...
describe('Service Tests', () => {
  describe('OrderHistory Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new OrderHistory('9fec3727-3421-4967-b213-ba36557ca194', 'AAAAAAA', 'AAAAAAA', currentDate, 'AAAAAAA', currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a OrderHistory', async () => {
      ...
      it('should not update a OrderHistory', async () => {
      ...
      it('should not partial update a OrderHistory', async () => {
      ...
      it('should not return a list of OrderHistory', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a OrderHistory', async () => {
