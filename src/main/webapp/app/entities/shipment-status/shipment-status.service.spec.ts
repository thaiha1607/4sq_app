...
import { ShipmentStatus } from '@/shared/model/shipment-status.model';
...
describe('Service Tests', () => {
  describe('ShipmentStatus Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a ShipmentStatus', async () => {
      ...
      it('should not update a ShipmentStatus', async () => {
      ...
      it('should not partial update a ShipmentStatus', async () => {
      ...
      it('should not return a list of ShipmentStatus', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a ShipmentStatus', async () => {
      ...
      it('should not delete a ShipmentStatus', async () => {
