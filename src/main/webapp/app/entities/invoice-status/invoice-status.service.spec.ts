...
import { InvoiceStatus } from '@/shared/model/invoice-status.model';
...
describe('Service Tests', () => {
  describe('InvoiceStatus Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a InvoiceStatus', async () => {
      ...
      it('should not update a InvoiceStatus', async () => {
      ...
      it('should not partial update a InvoiceStatus', async () => {
      ...
      it('should not return a list of InvoiceStatus', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a InvoiceStatus', async () => {
      ...
      it('should not delete a InvoiceStatus', async () => {
