...
import static com.foursquare.server.domain.CommentAsserts.*;
...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().rating(DEFAULT_RATING).content(DEFAULT_CONTENT);
        // Add required entity
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().rating(UPDATED_RATING).content(UPDATED_CONTENT);
        // Add required entity
        User user = UserResourceIT.createEntity(em);
        em.persist(user);
        em.flush();
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.rating(UPDATED_RATING).content(UPDATED_CONTENT);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.rating(UPDATED_RATING).content(UPDATED_CONTENT);
